...
parcelRequire = function(e, r, t, n) {
  ...
  "I+31": [function(require, module, exports) {
    "use strict";
    ...
    var i = require("./util"),
      ...
      a = function() {
        ...
        return o.prototype.startConnection = function(e) {
          ...
          }, r.default.log("Listening for remote stream"), e.onaddstream = function(e) {
            r.default.log("Received remote stream", e);
            var i = e.stream,
          ...
          if (e) {
            this.connection.peerConnection = null, e.onicecandidate = e.oniceconnectionstatechange = e.ondatachannel = e.onaddstream = function() {};
            ...
            return t(this, function(t) {
              switch (t.label) {
                ...
                case 6:
                  return [3, 8];
                case 7:
                  return p = t.sent(), o.emitError(c.PeerErrorType.WebRTC, p), r.default.log("Failed to createOffer, ", p), [3, 8];
                case 8:
                  return [2]
              }
            })
          ...
          if (r.default.log("add tracks from stream " + e.id + " to peer connection"), !n.addStream) return r.default.error("Your browser does't support RTCPeerConnection#addStream. Ignored.");
          n.addStream(e)
    ...
    var i = require("./util"),
      ...
      l = function(n) {
        function s(e, t, l) {
          ...
          return f.stringify = JSON.stringify, f.parse = JSON.parse, f._buffer = [], f._bufferSize = 0, f._buffering = !1, f._chunkedData = {}, f._encodingQueue = new u.EncodingQueue, f.connectionId = f.options.connectionId || s.ID_PREFIX + i.util.randomToken(), f.label = f.options.label || f.connectionId, f.serialization = f.options.serialization || a.SerializationType.JSON, f.reliable = !!f.options.reliable, f._encodingQueue.on("done", function(e) {
            f._bufferedSend(e)
    ...
    var i = require("eventemitter3"),
      ...
      f = function(o) {
        ...
        return e(i, o), Object.defineProperty(i.prototype, "id", {
          ...
          switch (o) {
            case 'data':
              this._lastServerId = this.id, this._open = !0, this.emit('data', i);
              break;
